...
#FUDO| still needs to be done
    ...
    def read_energy(self):
        ...
        #here, a problem might occur, if there are two 'Total Energy' statements as in the case of self-consistent non-local DF calculations, for now, simple fix is to iterate until file is completely read
        #FUCHECK| does that destroy other setups?
        for line in lines:
